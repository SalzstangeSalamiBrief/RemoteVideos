...
const privateKey = fs.readFileSync(path.join(__dirname, '../private/rsa/jwt/private.key'), 'utf-8');
const publicKey = fs.readFileSync(path.join(__dirname, '../private/rsa/jwt/public.key'), 'utf-8');
